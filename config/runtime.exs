...
#
#     PHX_SERVER=true bin/calori start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("CALORI_PHX_SERVER") do
  config :calori, CaloriWeb.Endpoint, server: true
end

if config_env() == :prod do
  # Set the cloud environment flag
  config :calori, env: System.fetch_env!("CALORI_CLOUD_ENVIRONMENT")
